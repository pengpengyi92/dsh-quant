# quant-history —— 量化大厂历史栏目

收录做市商与量化机构的**历史档案**：起源、关键人物、策略演进、文化、
里程碑与数据。首批三家：**Citadel · Optiver · Jane Street**。

> 定位：方法与历史的公开学习材料（dsh-quant 只讲公开事实与可验证数据；
> 内部策略与结论不在此列）。每个档案附「对量化 R&D 的启示」一节。
...
- 只收公开可验证事实，标注来源年份
- 每家一个文件；新机构 PR 附参考文献
- 历史叙事与开源 repo 分开：repo 专刊见 `quant-repo/`
- **尽调标准**：九段清单（创始人全景/成立时间/大事记/规模演变/
  策略/谱系/开源姿态/方向分析/参考来源 + 待核标注）见
  [DD_STANDARD.md](DD_STANDARD.md)——新档案与修订档案均按此标准
